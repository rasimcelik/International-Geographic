...
fetch("../json/south_america_sections.json")
  .then((response) => response.json())
  .then((data) => {
...
const firstWord =
  continentName.slice(0, 1).toUpperCase() + continentName.slice(1, 5);
const secondWord =
  continentName.slice(5, 6).toUpperCase() + continentName.slice(6);

const separatedContinentName = firstWord + " " + secondWord;

// Capitalize the first letter of each word
const capitalizedContinentName = separatedContinentName
  .split(" ")
...
// COUNTING THE COUNTRIES OF CONTINENT FUNCTION
...
fetch("../json/test.json")
  ...
  .then((data) => {
    ...
    const samericaCountries = data["SouthAmerica"];

    const sortedCountries = Object.entries(samericaCountries).sort((a, b) =>
